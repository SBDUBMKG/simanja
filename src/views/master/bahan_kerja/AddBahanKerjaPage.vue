    ...
    <div>
        ...
        <div class="container-add-master-bahan-kerja">
            ...
            <div class="container-content">
                ...
                <h6 id="subtitle-content" v-if="dataLoaded">Tambah Master Bahan Kerja {{ fungsionalData.fungsional }}</h6>
            ...
            if (bahanKerjaList.length === penggunaanList.length) {
                for (let i = 0; i < bahanKerjaList.length; i++) {
                    try {
                        ...
                        await axios.post(`http://localhost:5000/master/bahan-kerja`, payload, config);
                ...
                }).then(this.$router.push({ name: 'BahanKerjaDetail', params: { fungsionalid: this.fungsionalData.id_fungsional } }))
