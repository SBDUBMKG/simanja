    ...
    <div>
        ...
        <div class="container-detail-master-bahan-kerja">
            ...
            <div class="container-content">
                ...
                <h6 id="subtitle-content" v-if="dataLoaded">List Bahan Kerja {{ fungsionalData.fungsional }}</h6>
                        ...
                        <tr v-for="(bahanKerja, index) in daftarBahanKerja" :key="bahanKerja.id_bahan_kerja">
                            ...
                            <td>
                                <div class="d-flex justify-content-around">
                                    <button @click="editBtn(bahanKerja.id_bahan_kerja)" class="btn btn-warning btn-sm">
                                    ...
                                    <button @click="deleteBtn(bahanKerja.id_bahan_kerja)" class="btn btn-danger btn-sm">
