        ...
        <div class="container-detail-master-bakat-kerja">
            ...
            <div class="container-content">
                ...
                <div class="main-content shadow">
                    ...
                    <h6 class="subtitle-content">List Bakat Kerja</h6>
                            ...
                            <tr v-for="(bakatKerja, index) in daftarBakatKerja" :key="bakatKerja.id_bakat_kerja">
                                ...
                                <td>
                                    <div class="d-flex justify-content-around">
                                        <button @click="editBtn(bakatKerja.id_bakat_kerja)" class="btn btn-secondary btn-sm">
                                        ...
                                        <button @click="deleteBtn(bakatKerja.id_bakat_kerja)" class="btn btn-secondary btn-sm">
