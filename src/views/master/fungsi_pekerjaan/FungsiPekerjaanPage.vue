    ...
    <div>
        ...
        <div class="container-detail-master-fungsi-pekerjaan">
            ...
            <div class="container-content">
                ...
                <h6 id="subtitle-content">List Fungsi Pekerjaan</h6>
                        ...
                        <tr v-for="(fungsiPekerjaan, index) in daftarFungsiPekerjaan" :key="fungsiPekerjaan.id_fungsi_pekerjaan">
                            ...
                            <td>
                                <div class="d-flex justify-content-around">
                                    <button @click="editBtn(fungsiPekerjaan.id_fungsi_pekerjaan)" class="btn btn-warning btn-sm">
                                    ...
                                    <button @click="deleteBtn(fungsiPekerjaan.id_fungsi_pekerjaan)" class="btn btn-danger btn-sm">
