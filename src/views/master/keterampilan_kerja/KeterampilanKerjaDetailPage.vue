        ...
        <div class="container-detail-master-keterampilan-kerja">
            ...
            <div class="container-content">
                ...
                <div class="main-content shadow">
                    ...
                    <h6 class="subtitle-content" v-if="dataLoaded">List Keterampilan Kerja {{ fungsionalData.fungsional }}</h6>
                            ...
                            <tr v-for="(keterampilanKerja, index) in daftarKeterampilanKerja" :key="keterampilanKerja.id_keterampilan_kerja">
                                ...
                                <td>
                                    <div class="d-flex justify-content-around">
                                        <button @click="editBtn(keterampilanKerja.id_keterampilan_kerja)" class="btn btn-secondary btn-sm">
                                        ...
                                        <button @click="deleteBtn(keterampilanKerja.id_keterampilan_kerja)" class="btn btn-secondary btn-sm">
