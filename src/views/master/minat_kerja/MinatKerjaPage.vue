    ...
    <div>
        ...
        <div class="container-detail-master-minat-kerja">
            ...
            <div class="container-content">
                ...
                <h6 id="subtitle-content">List Minat Kerja</h6>
                        ...
                        <tr v-for="(minatKerja, index) in daftarMinatKerja" :key="minatKerja.id_minat_kerja">
                            ...
                            <td>
                                <div class="d-flex justify-content-around">
                                    <button @click="editBtn(minatKerja.id_minat_kerja)" class="btn btn-warning btn-sm">
                                    ...
                                    <button @click="deleteBtn(minatKerja.id_minat_kerja)" class="btn btn-danger btn-sm">
