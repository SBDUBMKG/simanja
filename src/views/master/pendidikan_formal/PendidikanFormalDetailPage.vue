                            ...
                            <tr v-for="(pendidikanFormal, index) in daftarPendidikanFormal" :key="pendidikanFormal.id_pendidikan">
                                ...
                                <td>
                                    <div class="d-flex justify-content-around">
                                        <button @click="editBtn(pendidikanFormal.id_pendidikan)" class="btn btn-secondary btn-sm">
                                        ...
                                        <button @click="deleteBtn(pendidikanFormal.id_pendidikan)" class="btn btn-secondary btn-sm">
