<template>
    <div>
        <NavbarDashboard/>
        <div class="container-master-pendidikan-formal">
            <SidebarMenu/>
                ...
                <DataTable v-if="loaded" class="table table-bordered table-sm table-hover table-responsive-xl display">
                    ...
                    <tbody>
                        <tr v-for="jabatan in daftarjabatan" :key="jabatan.id_fungsional">
                            ...
                            <td>
                                <router-link :to="{ name: 'PendidikanFormalDetail', params: { fungsionalid: jabatan.id_fungsional } }">
                                    Detail
                                </router-link>
                            </td>
                        </tr>
...
.container-master-pendidikan-formal{
    display: flex;
}
