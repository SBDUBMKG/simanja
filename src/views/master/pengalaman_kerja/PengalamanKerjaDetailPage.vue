        ...
        <div class="container-detail-master-pengalaman-kerja">
            ...
            <div class="container-content">
                ...
                <div class="main-content shadow">
                    ...
                    <h6 class="subtitle-content" v-if="dataLoaded">List Pengalaman Kerja {{ fungsionalData.fungsional }}</h6>
                            ...
                            <tr v-for="(pengalamanKerja, index) in daftarPengalamanKerja" :key="pengalamanKerja.id_pengalaman">
                                ...
                                <td>
                                    <div class="d-flex justify-content-around">
                                        <button @click="editBtn(pengalamanKerja.id_pengalaman)" class="btn btn-warning btn-sm">
                                        ...
                                        <button @click="deleteBtn(pengalamanKerja.id_pengalaman)" class="btn btn-danger btn-sm">
    ...
    methods: {
        ...
        async loadPengalamanKerja() {
            try {
                ...
                const response = await axios.get(`${process.env.VUE_APP_BACKENDHOST}/master/pengalaman/fungsional/${this.fungsionalId}`, config);
