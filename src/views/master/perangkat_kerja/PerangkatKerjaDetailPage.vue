        ...
        <div class="container-detail-master-perangkat-kerja">
            ...
            <div class="container-content">
                ...
                <div class="main-content shadow">
                    ...
                    <h6 class="subtitle-content" v-if="dataLoaded">List Perangkat Kerja {{ fungsionalData.fungsional }}</h6>
                            ...
                            <tr v-for="(perangkatKerja, index) in daftarPerangkatKerja" :key="perangkatKerja.id_perangkat_kerja">
                                ...
                                <td>
                                    <div class="d-flex justify-content-around">
                                        <button @click="editBtn(perangkatKerja.id_perangkat_kerja)" class="btn btn-warning btn-sm">
                                        ...
                                        <button @click="deleteBtn(perangkatKerja.id_perangkat_kerja)" class="btn btn-danger btn-sm">
