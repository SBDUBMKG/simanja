        ...
        <div class="container-add-master-tanggung-jawab">
            ...
            <div class="container-content">
                ...
                <div class="main-content shadow">
                    ...
                    <h6 class="subtitle-content" v-if="dataLoaded">Tambah Master Tanggung Jawab {{ fungsionalData.fungsional }}</h6>
...
export default {
    ...
    methods: {
        ...
        async saveTanggungJawab () {
            ...
            }).then(this.$router.push({ name: 'TanggungJawabDetail', params: { fungsionalid: this.fungsionalData.id_fungsional } }))
        }
    },
};
</script>
