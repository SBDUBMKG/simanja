        ...
        <div class="container-detail-master-tanggung-jawab">
            ...
            <div class="container-content">
                ...
                <div class="main-content shadow">
                    ...
                    <h6 class="subtitle-content" v-if="dataLoaded">List Tanggung Jawab {{ fungsionalData.fungsional }}</h6>
                            ...
                            <tr v-for="(tanggungJawab, index) in daftarTanggungJawab" :key="tanggungJawab.id_tanggung_jawab">
                                ...
                                <td>
                                    <div class="d-flex justify-content-around">
                                        <button @click="editBtn(tanggungJawab.id_tanggung_jawab)" class="btn btn-warning btn-sm">
                                        ...
                                        <button @click="deleteBtn(tanggungJawab.id_tanggung_jawab)" class="btn btn-danger btn-sm">
    ...
    methods: {
        ...
        async loadTanggungJawab() {
            try {
                ...
                const response = await axios.get(`${process.env.VUE_APP_BACKENDHOST}/master/tanggung-jawab/fungsional/${this.fungsionalId}`, config);
