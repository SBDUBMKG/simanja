<template>
    <div>
        <div class="container-master-tanggung-jawab">
            <SidebarMenu/>
                    ...
                    <DataTable v-if="loaded" class="table table-bordered table-sm table-hover table-responsive-xl display">
                        ...
                        <tbody>
                            <tr v-for="jabatan in daftarjabatan" :key="jabatan.id_fungsional">
                                ...
                                <td>
                                    <router-link :to="{ name: 'TanggungJawabDetail', params: { fungsionalid: jabatan.id_fungsional } }">
                                        Detail
                                    </router-link>
                                </td>
                            </tr>
...
.container-master-tanggung-jawab {
    display: flex;
}
</style>
